...
(function() {
  ...
  model.publish(rh.consts('KEY_SEARCH_BG_COLOR'), "#FCFF00");
	...
	model.publish(rh.consts('KEY_CUSTOM_BUTTONS_CONFIG'), [{"image":"expand_all.svg","name":"Expand/Collapse All","onclick":"rh.model.publish(rh.consts('EVT_EXPAND_COLLAPSE_ALL'));return false;","title":"Expand/Collapse All","id":"0","key":"3923"},{"image":"removesearch_mark.svg","name":"RemoveHighlight","onclick":"rh.model.publish(rh.consts('EVT_REMOVE_HIGHLIGHT'));return false;","title":"Remove Highlight","id":"1","key":"3924"},{"image":"print_desktop.png","name":"Print","onclick":"rh.model.publish(rh.consts('EVT_PRINT_TOPIC'));return false;","title":"Print","id":"2","key":"3925"}])
...
(function() {
	document.addEventListener('DOMContentLoaded', function () {
		rh._.delay(function() {
					...
					document.getElementById("custom-button-0").addEventListener('click', () => {rh.model.publish(rh.consts('EVT_EXPAND_COLLAPSE_ALL'));return false;});
				
				
				
			
				
					document.getElementById("custom-button-1").addEventListener('click', () => {rh.model.publish(rh.consts('EVT_REMOVE_HIGHLIGHT'));return false;});
